...
var typed = new Typed('#text',{
    strings: ['Полинка, с 8 марта! Пусть этот день будет таким же солнечным, как твоя улыбка! Пусть мечты сбываются, а счастье и любовь наполняют каждый миг твоей жизни. Будь самой счастливой и любимой! ❤️'],
    startDelay: 3000,
    typeSpeed: 50,
    backSpeed: 0,
    fadeOut: true,
